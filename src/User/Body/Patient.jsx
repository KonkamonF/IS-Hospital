...
const detailContent = {
  ...
  diagnosis: {
    ...
    details: [
      ...
      {
        label: "อาการที่พบล่าสุด",
        value: "ไข้สูง $38.8^circ C$, $O_2$ Sat 94%",
      },
    ],
  },
  treatment: {
...
const ROOM_DATA_SIMPLE = [
  {
    ...
    benefits:
      "ค่าห้อง+อาหาร (17,550฿) | พยาบาล (4,200฿) | สิ่งอำนวยความสะดวกครบครัน",
  },
  {
    type: "Ward 4A (Standard)",
    price: "8,500 บาท/คืน",
    benefits:
      "ค่าห้อง+อาหาร (8,500฿) | พยาบาล (2,500฿) | ห้องน้ำภายใน, ตู้เย็น, ทีวี",
  },
  {
    type: "VIP Suite (Luxury)",
    price: "35,000 บาท/คืน",
    benefits:
      "ค่าห้อง+อาหาร (35,000฿) | พยาบาล (6,000฿) | ห้องรับแขก, ครัวเล็ก, อ่างอาบน้ำ",
  },
  {
    type: "Semi-Private (Superior)",
    price: "12,000 บาท/คืน",
    benefits:
      "ค่าห้อง+อาหาร (12,000฿) | พยาบาล (3,500฿) | โซฟา, ห้องน้ำรวม, WiFi, ทีวี",
  },
  {
    type: "Pediatric Ward (Child)",
    price: "7,000 บาท/คืน",
    benefits:
      "ค่าห้อง+อาหาร (7,000฿) | พยาบาล (2,800฿) | เตียงเด็ก, โซฟาผู้ปกครอง, มุมของเล่น",
  },
  {
    type: "VIP Family Room",
    price: "25,000 บาท/คืน",
    benefits:
      "ค่าห้อง+อาหาร (25,000฿) | พยาบาล (5,000฿) | ห้องนั่งเล่น, ครัวเล็ก, 2 เตียง",
  },
];
  ...
  return (
    ...
    >
      <div>
        ...
        {/* Value (ข้อมูลหลัก) */}
        <p className={`text-3xl font-extrabold ${colorClass} mb-2`}>{value}</p>
        {/* Detail (ข้อมูลรอง) */}
...
const RoomSelectionModal = ({ onClose, currentRoom }) => {
  ...
  const handleConfirm = () => {
    ...
    console.log(
      `ยืนยันการขอเปลี่ยนเป็น: ${selectedRoom.type} ราคา ${selectedRoom.price} - ระบบจะดำเนินการตรวจสอบวงเงินและห้องว่าง`
    );
  ...
  return (
    <div className="fixed inset-0 bg-gray-900 bg-opacity-75 flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-xl shadow-2xl w-full max-w-xl mx-auto transform transition-all duration-300 scale-100">
        ...
        <div className="p-6 border-b flex justify-between items-center bg-green-600 rounded-t-xl">
          <h3 className="text-2xl font-bold text-white">
            🛏 เลือก/เปลี่ยนห้องพัก
          </h3>
          <button
            onClick={onClose}
            className="text-white hover:text-gray-200 transition text-3xl font-light"
        ...
        <div className="p-6 border-t flex justify-between items-center">
          ...
          <button
            ...
            className="px-5 py-2 bg-green-500 text-white font-bold rounded-lg shadow-md hover:bg-green-800 transition disabled:bg-gray-400 disabled:cursor-not-allowed"
...
export default function PatientDashboard() {
  ...
  return (
    <div className="p-4 md:p-8 bg-gray-50 min-h-screen font-kanit">
      ...
      {/* 4. ปุ่มเลือกห้องพัก (ใช้สีชมพูตามคำขอ) */}
      <div className="mt-8 lg:col-span-4">
        ...
        >
          {/* SVG Icon: เครื่องหมายบวก (Plus Sign) เพื่อสื่อถึงการ 'เลือก/เปลี่ยน' */}
          <svg
